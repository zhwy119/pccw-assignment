!function(e, t) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : (e = "undefined" != typeof globalThis ? globalThis : e || self).axios = t()
        ...
        ;
        var R, T = Object.prototype.toString, j = Object.getPrototypeOf, k = (R = Object.create(null),
                function(e) {
                    var t = T.call(e);
        ...
        var Z, ee = (Z = "undefined" != typeof Uint8Array && j(Uint8Array),
                function(e) {
        ...
        var ue = A("AsyncFunction")
            ...
            generateString: function() {
                for (var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 16, t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : se.ALPHA_DIGIT, r = "", n = t.length; e--; )
                    r += t[Math.random() * n | 0];
                return r
            },
        ...
        function me(e, t, r) {
            ...
            function c(e, r, o) {
                ...
                if (e && !o && "object" === f(e))
                    ...
                    }(e) || (ce.isFileList(e) || ce.endsWith(r, "[]")) && (s = ce.toArray(e)))
                        return r = de(r),
                            ...
                            !1;
                return !!pe(e) || (t.append(ye(o, r, i), u(e)),
                    !1)
            }
            var l = []
                , h = Object.assign(ve, {
        ...
        }, je = "undefined" != typeof window && "undefined" != typeof document, ke = (Se = "undefined" != typeof navigator && navigator.product,
        je && ["ReactNative", "NativeScript", "NS"].indexOf(Se) < 0), Ae = "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope && "function" == typeof self.importScripts, Pe = je && window.location.href || "http://localhost", Le = s(s({}, Object.freeze({
            __proto__: null,
            hasBrowserEnv: je,
        ...
        function Ne(e) {
            function t(e, r, n, o) {
                ...
                var a = Number.isFinite(+i)
                    , s = o >= e.length;
                return i = !i && ce.isArray(n) ? n.length : i,
                    s ? (ce.hasOwnProp(n, i) ? n[i] = [n[i], r] : n[i] = r,
                        !a) : (n[i] && ce.isObject(n[i]) || (n[i] = []),
                    t(e, r, n[i], o) && ce.isArray(n[i]) && (n[i] = function(e) {
        ...
        var _e = {
            ...
            transformRequest: [function(e, t) {
                ...
                if (i && ce.isHTMLForm(e) && (e = new FormData(e)),
                    ce.isFormData(e))
                    return o ? JSON.stringify(Ne(e)) : e;
                if (ce.isArrayBuffer(e) || ce.isBuffer(e) || ce.isStream(e) || ce.isFile(e) || ce.isBlob(e) || ce.isReadableStream(e))
                    return e;
                if (ce.isArrayBufferView(e))
                    return e.buffer;
                        ...
                        return function(e, t) {
                            return me(e, new Le.classes.URLSearchParams, Object.assign({
                                visitor: function(e, t, r, n) {
                                    return Le.isNode && ce.isBuffer(e) ? (this.append(t, e.toString("base64")),
            ...
            transformResponse: [function(e) {
                ...
                if (ce.isResponse(e) || ce.isReadableStream(e))
                    return e;
        ...
        function Ie(e, t, r, n, o) {
            return ce.isFunction(n) ? n.call(this, t, r) : (o && (t = r),
        ...
        var qe = function(e, t) {
            ...
            return y(r, [{
                ...
                value: function(e, t, r) {
                    ...
                    if (ce.isPlainObject(e) || e instanceof this.constructor)
                        i(e, t);
                        ...
                        i(function(e) {
                            ...
                            return e && e.split("\n").forEach((function(e) {
                                    ...
                                    !t || o[t] && Fe[t] || ("set-cookie" === t ? o[t] ? o[t].push(r) : o[t] = [r] : o[t] = o[t] ? o[t] + ", " + r : r)
                                }
                            )),
                                o
                        }(e), t);
                ...
                value: function(e, t) {
                    ...
                    function o(e) {
                        if (e = De(e)) {
                            ...
                            !o || t && !Ie(0, r[o], o, t) || (delete r[o],
                                n = !0)
                        }
                    }
                    return ce.isArray(e) ? e.forEach(o) : o(e),
                        n
                }
            }, {
                key: "clear",
                value: function(e) {
                    for (var t = Object.keys(this), r = t.length, n = !1; r--; ) {
                        var o = t[r];
                        e && !Ie(0, this[o], o, e, !0) || (delete this[o],
                            n = !0)
                    }
                    return n
                }
                ...
                value: function(e) {
                    ...
                    return ce.isArray(e) ? e.forEach(n) : n(e),
                        this
                }
            }]),
                r
        ...
        var et, tt, rt, nt, ot = function(e) {
            var t, r, n = Ze({}, e), o = n.data, i = n.withXSRFToken, a = n.xsrfHeaderName, s = n.xsrfCookieName, u = n.headers, c = n.auth;
            if (n.headers = u = ze.from(u),
            ...
            if (Le.hasStandardBrowserEnv && (i && ce.isFunction(i) && (i = i(n)),
            i || !1 !== i && Xe(n.url))) {
                var d = a && s && $e.read(s);
                d && u.set(a, d)
            }
            ...
            return new Promise((function(t, r) {
                    ...
                    c.open(o.method.toUpperCase(), o.url, !0),
                        ...
                        ,
                        c.onabort = function() {
                            c && (r(new fe("Request aborted",fe.ECONNABORTED,o,c)),
                                c = null)
                        }
                        ,
                        c.onerror = function() {
                            r(new fe("Network Error",fe.ERR_NETWORK,o,c)),
                                c = null
                        }
                        ,
                    ...
                    "setRequestHeader"in c && ce.forEach(a.toJSON(), (function(e, t) {
                    ...
                    (o.cancelToken || o.signal) && (n = function(t) {
                        c && (r(!t || t.type ? new Je(null,e,c) : t),
                            c.abort(),
                            c = null)
                    }
                        ,
        ...
        }, lt = "function" == typeof fetch && "function" == typeof Request && "function" == typeof Response, ht = lt && "function" == typeof ReadableStream, pt = lt && ("function" == typeof TextEncoder ? (et = new TextEncoder,
                function(e) {
                    return et.encode(e)
                }
        ) : function() {
            ...
            var e = h(u().mark((function e(t, r) {
                    ...
                    return u().wrap((function(e) {
                            for (; ; )
                                switch (e.prev = e.next) {
                                    case 0:
                                        return n = ce.toFiniteNumber(t.getContentLength()),
                    ...
                    return u().wrap((function(e) {
                            for (; ; )
                                switch (e.prev = e.next) {
                                    ...
                                    case 15:
                                        return ce.isString(v) || (v = v ? "cors" : "omit"),
                                            x = new Request(n,s(s({}, b), {}, {
                                                signal: E,
        ...
        function Rt(e) {
            ...
            -1 !== ["post", "put", "patch"].indexOf(e.method) && e.headers.setContentType("application/x-www-form-urlencoded", !1),
                St(e.adapter || Ce.adapter)(e).then((function(t) {
                        return xt(e),
        ...
        var At = {
            ...
            return y(e, [{
                ...
                value: function(e, t) {
                    ...
                    null != o && (ce.isFunction(o) ? t.paramsSerializer = {
                        serialize: o
                    } : At.assertOptions(o, {
                        encode: Pt.function,
        ...
        var Nt = Lt
            ...
            function e(t) {
                ...
                this.promise.then((function(e) {
                    ...
                    ,
                    t((function(e, t, o) {
                            n.reason || (n.reason = new Je(e,t,o),
                                r(n.reason))
                        }
                    ))
            }
